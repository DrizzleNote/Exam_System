		...
		$.post(
			...
			function(res){
				...
				for(var key in res.gets)
					$('#detaile_get').append(
						'<tr role="row"><th tabindex="0" aria-controls="data_table" rowspan="1" colspan="1" aria-sort="ascending" >'+(i++)+'</th><th tabindex="0" aria-controls="data_table" rowspan="1" colspan="1" aria-sort="ascending" >'+key+'</th><th tabindex="0" class="name" aria-controls="data_table" rowspan="1" colspan="1" aria-sort="ascending" >'+res.gets[key]+'</tr>');
				...
				for(var key in res.posts)
					$('#detaile_post').append(
						'<tr role="row"><th tabindex="0" aria-controls="data_table" rowspan="1" colspan="1" aria-sort="ascending" >'+(i++)+'</th><th tabindex="0" aria-controls="data_table" rowspan="1" colspan="1" aria-sort="ascending" >'+key+'</th><th tabindex="0" class="name" aria-controls="data_table" rowspan="1" colspan="1" aria-sort="ascending" >'+res.posts[key]+'</tr>'
						);
