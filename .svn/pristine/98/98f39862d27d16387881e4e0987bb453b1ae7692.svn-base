        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php $form = ActiveForm::begin(["id" => "admin-role-form", "class"=>"form-horizontal", "action"=>Url::toRoute("admin-role/view")]); ?>
                    ...
                    <div id="des_div" class="form-group">
                        ...
                        <div class="col-sm-10">
                          <textarea class="form-control" id="answer" name="Questions[Answer]" collapse="3"></textarea>
                        </div>
                        <div class="clearfix"></div>
                    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <?php $form = ActiveForm::begin(["id" => "system-role-form", "class"=>"form-horizontal", "action"=>Url::toRoute("system-role/view")]); ?>
                    <div id="treeview"></div>
                    <?php ActiveForm::end(); ?>
                </div>
                <div class="modal-footer">
...
<?php $this->beginBlock('footer');  ?>
    ...
    <script>
        ...
        $.post(
            "<?=Url::toRoute('general/search-general')?>",
            {
                key:key,
            },
            function(res)
        ...
        $('#stage-choice').change(function () {
            var Tmp = $(this).val();
            window.location.href = '<?=Url::toRoute('general/index')?>'+'&stage='+Tmp;
        })
        ...
        function initEditSystemModule(data, type){
            ...
            if(type == "view"){
                ...
                $("#answer").attr({readonly:true,disabled:true});
                ...
                $("#answer").attr({readonly:false,disabled:false});
         ...
         function IsSee(id,me)
        {
            ...
            // alert($(me).html());
            $.post(
                "<?=Url::toRoute('general/change-see')?>",
                {
                    QuestionBh:id,
                },
                function(res){
        ...
        {
            $.post(
                "<?=Url::toRoute('general/change-checked')?>",
                {
                    QuestionBh:id,
                },
                function(res){
        ...
        function deleteAction(id){
            ...
            if(ids.length > 0){
                admin_tool.confirm('请确认是否删除', function(){
                    $.ajax({
                        type: "GET",
                        url: "<?=Url::toRoute('general/delete')?>",
                        data: {"ids":ids},
                        cache: false,
                        dataType:"json",
                        error: function (xmlHttpRequest, textStatus, errorThrown) {
        ...
        $('#create_btn').click(function (e) {
            e.preventDefault();
            window.location.href = "<?=Url::toRoute('general/add')?>"
        });
        ...
        $('#admin-role-form').bind('submit', function(e) {
            e.preventDefault();
            var id = $("#id").val();
            var action = id == "" ? "<?=Url::toRoute('general/create')?>" : "<?=Url::toRoute('general/update')?>";
            $(this).ajaxSubmit({
                type: "post",
                dataType:"json",
                url: action,
