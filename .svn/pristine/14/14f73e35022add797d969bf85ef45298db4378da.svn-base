        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php $form = ActiveForm::begin(["id" => "admin-role-form", "class"=>"form-horizontal", "action"=>Url::toRoute("choice/view")]); ?>
                    ...
                    <div id="college_div" class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" name="Questions[Stage]" id="stage">
                                    <?php foreach ($stage as $model){?>
                                        <option value="<?=$model->CuitMoon_DictionaryCode?>"><?=$model->CuitMoon_DictionaryName?></option>
                                    <?php }?>
                                </select>
                    ...
                    <div id="des_div" class="form-group">
                        ...
                        <div class="col-sm-10">
                                <select class="form-control" name="Questions[KnowledgeBh]" id="knowledgePoint" >
                    ...
                    <div id="des_div" class="form-group">
                        ...
                        <div class="col-sm-10">
                            <label class="checkbox-inline">
                                <input type="checkbox" id="inlineCheckbox1" value="A" name="Questions[Answer]"> A
                            </label>
                            <label class="checkbox-inline">
                                <input type="checkbox" id="inlineCheckbox2" value="B" name="Questions[Answer]"> B
                            </label>
                            <label class="checkbox-inline">
                                <input type="checkbox" id="inlineCheckbox3" value="C" name="Questions[Answer]"> C
                            </label>
                            <label class="checkbox-inline">
                                <input type="checkbox" id="inlineCheckbox4" value="D" name="Questions[Answer]"> D
                            </label>
...
<?php $this->beginBlock('footer');  ?>
    ...
    <script>
        ...
        $.post(
            "<?=Url::toRoute('choice/search-choice')?>",
            {
                key:key,
            },
            function(res)
    ...
    $('#stage-choice').change(function () {
        var Tmp = $(this).val();
        window.location.href = '<?=Url::toRoute('choice/index')?>'+'&stage='+Tmp;
    })
        ...
        function initEditSystemModule(data, type){
            if(type == 'create'){
                ...
                $("#knowledgePoint").val(data['KnowledgeBh']);
            ...
            if(type == "view"){
                ...
                $("#knowledgePoint").attr({readonly:true,disabled:true});
                ...
                $("#knowledgePoint").attr({readonly:false,disabled:false});
        ...
        function checkAction(id,me){
            $.ajax({
                type: "GET",
                url: "<?=Url::toRoute('judgement/check')?>",
                data: {"QuestionBh": id},
                cache: false,
                dataType: "json",
                error: function (xmlHttpRequest, textStatus, errorThrown) {
                ...
                success: function (data) {
                     ...
                     //window.location.reload();
                      ...
                      $(me).html('<i class="glyphicon glyphicon-edit icon-white"></i>已审核');
                     }
                     else
                     {
                         $(me).attr('class','btn btn-danger btn-sm');
                         $(me).html('<i class="glyphicon glyphicon-edit icon-white"></i>审核');
                     }
        ...
        function publishAction(id,me){
            $.ajax({
                type: "GET",
                url: "<?=Url::toRoute('judgement/publish')?>",
                data: {"QuestionBh": id},
                cache: false,
                dataType: "json",
                error: function (xmlHttpRequest, textStatus, errorThrown) {
                ...
                success: function (data) {
                     ...
                     //window.location.reload();
                      ...
                      $(me).html('<i class="glyphicon glyphicon-edit icon-white"></i>已公开');
                     }
                     else
                     {
                         $(me).attr('class','btn btn-danger btn-sm');
                         $(me).html('<i class="glyphicon glyphicon-edit icon-white"></i>公开');
                     }
        ...
        $('#create_btn').click(function (e) {
            e.preventDefault();
            window.location.href = "<?=Url::toRoute('choice/add')?>"
        });
        ...
        $('#admin-role-form').bind('submit', function(e) {
            e.preventDefault();
            var id = $("#id").val();
            var action = id == "" ? "<?=Url::toRoute('choice/create')?>" : "<?=Url::toRoute('choice/update')?>";
            $(this).ajaxSubmit({
                type: "post",
                dataType:"json",
                url: action,
