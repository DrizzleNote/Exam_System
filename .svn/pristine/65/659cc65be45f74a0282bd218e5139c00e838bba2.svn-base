    ...
    switch ($type){
        ...
        case '1000203':
           /* echo '<input disabled="disabled" type="radio" value="1" name="'.$question['QuestionBh'].'"/>&nbsp;&nbsp;对
            ...
            break;
        case '1000204':
             echo '<input class="100204" type="text" id="score_'.$Tmp_Bh.'" placeholder="0~'.$Tmp_score.'" /><button id="get_score_'.$Tmp_Bh.'" type="button" class="btn btn-info hasCheck" onclick="score('."'$Tmp_Bh'".')">打分</button>';
            break;
        case '1000205':
        ...
        case '1000206':
            ...
            <button id="compile'.$question['QuestionBh'].'" class="btn btn-default"  type="button" onclick="compile('."'$QuestionBh'".')">编译</button><label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;分数:</label>&nbsp;&nbsp;<strong id="score'.$question['QuestionBh'].'"></strong></br></br>';
            echo '<input type="text" id="score_'.$Tmp_Bh.'" placeholder="0~'.$Tmp_score.'" /><button id="get_score_'.$Tmp_Bh.'" type="button" class="btn btn-info hasCheck" onclick="score('."'$Tmp_Bh'".')">打分</button>';
        ...
        case '1000208':
            ...
            echo '<input id="score_'.$Tmp_Bh.'" type="text" id="score_'.$Tmp_Bh.'"  placeholder="0~'.$Tmp_score.'"/><button id="get_score_'.$Tmp_Bh.'" type="button" class="btn btn-info" onclick="score('."'$Tmp_Bh'".')" >打分</button>';
            break;
        default:
            break;
    }
