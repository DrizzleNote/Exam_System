        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">判断题管理->判断题添加</h3>
                </div>
                <h1></h1>
                <div class="box-body">
                    <?php ActiveForm::begin(['id'=>'programAdd', 'method' => 'post', 'class' => 'form-horizontal'] )?>
                    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-6">
                                <label class="checkbox-inline">
                                    <input type="checkbox" id="inlineCheckbox1" value="1" name="Questions[Answer]"> 1
                                </label>
                                <label class="checkbox-inline">
                                    <input type="checkbox" id="inlineCheckbox2" value="0" name="Questions[Answer]"> 0
                                </label>
...
<script type="text/javascript">
    ...
    //submit form
    $('#programAdd').bind('submit',function (e) {
        e.preventDefault();
        $(this).ajaxSubmit({
            type:'POST',
            dataType:'json',
            url:'<?=Url::toRoute("judgement/create")?>',
            success:function (value) {
                if(value.error == 0){
                    alert('添加成功');
                    window.location.href = '<?=Url::toRoute("judgement/index")?>'
                }else{
                    alert('添加失败');
                }
            }
