                                    ...
                                    if($choice['Term_Choice']) {
                                        ...
                                        foreach ($list as $model) {
                                            ...
                                            if ($model->SubmitStage) {
                                                echo '      <a id="submit_paper_'.$model->PaperID.'" onclick="submitAlone(' . "'$model->PaperID'" . ')" class="btn btn-primary btn-sm"  href="#" disabled="disabled"> <i class="glyphicon glyphicon-zoom-in icon-white"></i>交卷</a>';
                                                ...
                                                echo '      <a id="submit_paper_'.$model->PaperID.'" onclick="submitAlone(' . "'$model->PaperID'" . ')" class="btn btn-primary btn-sm"  href="#"> <i class="glyphicon glyphicon-zoom-in icon-white"></i>交卷</a>';
                                                // echo '      <a id="view_btn_2" onclick="correct(' . "'$model->PaperID'" . ')" class="btn btn-warning btn-sm"  disabled="disabled" href="#"> <i class="glyphicon glyphicon-zoom-in icon-white"></i>修正</a>';
                                            }
...
<script>
    ...
    function correct(id) {
        ...
        if (state == 'disabled') {
            if (Class != null) {
                window.location.href = '<?=Url::toRoute("exam-info/correct")?>'+'&term='+$("#term-choice").val()+'&examPlan='
                    +$("#teach-choice").val()+'&classID='+Class+'&id=' + id;
            } else {
                window.location.href = '<?=Url::toRoute('exam-info/correct')?>' + '&id=' + id;
            }
        }
    }
