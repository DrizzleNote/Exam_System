...
<div class="wrap">
<h1 style="text-align: center;">学生作业管理</h1>
<table id="myTable" class="table table-condensed view1">
    <!-- On rows -->
  <tr class="active">
      <th class="success">序号</th>
      <th class="info">作业名称</th>
      <th class="danger">所属班级</th>
      <th class="warning">截止时间</th>
      <th class="success">是否截止</th>
      <th class="info">上传状态</th>
      <th class="danger">作业内容</th>
      <th class="warning">个人答案</th>
...
<script type="text/javascript">
     function num(s){
        ...
        $(document).ready(function(){
          var addTr = '<tr class="success"><td class="info num"></td><td class="success Name"></td><td class="warning ClassNum"></td><td class="danger date"></td><td class="info overdue">未截止</td><td class="success load"></td><td class="warning"><a class="look" href="#">详情</a></td><td class="danger"><a class="check" href="#">详情</a></td><td class="info"><a class="upTo" href="#">上传</a></td></tr>';
